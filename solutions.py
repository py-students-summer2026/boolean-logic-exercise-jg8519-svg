...
def is_humid():
    ...
    return humid == "yes" or humid == "Yes" or humid == "YES"
...
def is_inclement():
    ...
    weather = input("What is the weather forecast today? (rain/snow/sleet): ")
    return weather == "rain" or weather == "snow" or weather == "sleet"
